                        ...
                        <div className="w-full lg:w-3/5">
                            <div className='pb-5 md:pb-0 lg:px-0 text-left'>
                                ...
                                <ul className="list-disc space-y-4 lg:space-y-2 2xl:space-y-3 pl-8 lg:pl-6">
                                    ...
                                    <li><p className="text-lg lg:text-[1.2rem] 2xl:text-[1.5rem] leading-8 lg:leading-normal">architektura</p></li>
                                    <li><p className="text-lg lg:text-[1.2rem] 2xl:text-[1.5rem] leading-8 lg:leading-normal">geologia, hydrologia, archeologia</p></li>
                                    <li><p className="text-lg lg:text-[1.2rem] 2xl:text-[1.5rem] leading-8 lg:leading-normal">planowanie przestrzenne</p></li>
                                    <li><p className="text-lg lg:text-[1.2rem] 2xl:text-[1.5rem] leading-8 lg:leading-normal">ochrona środowiska</p></li>
                                    <li><p className="text-lg lg:text-[1.2rem] 2xl:text-[1.5rem] leading-8 lg:leading-normal">zakłady wydobywcze</p></li>
                                    <li><p className="text-lg lg:text-[1.2rem] 2xl:text-[1.5rem] leading-8 lg:leading-normal">sprzedaż nieruchomości</p></li>
                                    <li><p className="text-lg lg:text-[1.2rem] 2xl:text-[1.5rem] leading-8 lg:leading-normal">zarządzanie nieruchomościami</p></li>
                                    <li><p className="text-lg lg:text-[1.2rem] 2xl:text-[1.5rem] leading-8 lg:leading-normal">wiele więcej</p></li>
                                </ul>
                            </div>
                        </div>
                    </div>
