    ...
    return (
        <div className="bg-background2 bg-cover bg-no-repeat bg-bottom" id="about">
            <div className="backdrop-grayscale-0 bg-white/75">
                <div className="container mx-auto md:min-h-screen md:flex md:flex-col md:justify-center md:items-center py-14 2xl:py-0">
                    ...
                    <div className="px-4 lg:px-0 pt-10 md:pt-12 2xl:pt-20 grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 md:gap-6">
                        <div className="mb-10 md:mb-0">
                            ...
                            <p className="text-center pt-5 text-lg lg:text-[1.1rem] 2xl:text-[1.5rem] font-regular 2xl:leading-8">Wiemy jak cenny jest czas, dlatego opracowania przygotowywane są nawet w dniu wykonania pomiaru</p>
                        </div>
                        <div className="mb-10 md:mb-0">
                            <img src="ruler.png" alt="ruler icon" className="mx-auto mb-10 lg:mb-5 2xl:mb-10 w-1/5 md:w-1/3 lg:w-1/4 2xl:w-auto" />
                            <p className="font-semibold text-center text-xl lg:text-[1.2rem] 2xl:text-[1.6rem] md:h-[3.5rem] lg:h-[1.5rem] 2xl:h-[2.5rem]">Precyzja i dokładność</p>
                            <p className="text-center pt-5 text-lg lg:text-[1.1rem] 2xl:text-[1.5rem] font-regular 2xl:leading-8">Opracowania z georeferencją i dokładnością na poziomie geodezyjnym</p>
                        </div>
                        <div className="mb-10 md:mb-0">
                            <img src="tools.png" alt="tools icon" className="mx-auto mb-10 lg:mb-5 2xl:mb-10 w-1/5 md:w-1/3 lg:w-1/4 2xl:w-auto" />
                            <p className="font-semibold text-center text-xl lg:text-[1.2rem] 2xl:text-[1.6rem] md:h-[3.5rem] lg:h-[1.5rem] 2xl:h-[2.5rem]">Fachowość</p>
                            <p className="text-center pt-5 text-lg lg:text-[1.1rem] 2xl:text-[1.5rem] font-regular 2xl:leading-8">Wykształcenie, doświadczenie, najwyższej jakości sprzęt pomiarowy oraz praca na najwyższej jakości oprogramowaniu</p>
                        </div>
                        <div className="mb-10 md:mb-0">
                            <img src="hands.png" alt="partnership icon" className="mx-auto mb-10 lg:mb-5 2xl:mb-10 w-1/5 md:w-1/3 lg:w-1/4 2xl:w-auto" />
                            <p className="font-semibold text-center text-xl lg:text-[1.2rem] 2xl:text-[1.6rem] md:h-[3.5rem] lg:h-[1.5rem] 2xl:h-[2.5rem]">Rzetelność i autentyczność</p>
                            <p className="text-center pt-5 text-lg lg:text-[1.1rem] 2xl:text-[1.5rem] font-regular 2xl:leading-8">KD Fotogrametria powstała po to, aby świadczyć usługi pomocne w Twojej branży na najwyższym poziomie</p>
                        </div>
                    </div>
                </div>
            </div>
